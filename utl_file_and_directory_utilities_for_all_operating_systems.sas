...
Many of these have unique advantages, however the windows tool to create
SAS dataset from a directory is  #11. It has a lot of bells and whistles.
...
http://support.sas.com/kb/24/820.html
 ...
 Directory and File Tools
  ...
  11.  Windows: Another Windows directory into macro variable (DIRLISTWIN)
